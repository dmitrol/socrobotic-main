...
<template>
    <div class="facebook__inner" v-if="width > 743">
        <h3 class="facebook__inner-title">{{ t('accounts') }}</h3>
            ...
            <table class="facebook__table">
                <thead>
                    <tr class="facebook__table-tr">
                        ...
                        <th class="facebook__table-th">{{ t('account') }}</th>
                        <th class="facebook__table-th">{{ t('city') }}</th>
                        <th class="facebook__table-th">{{ t('friends') }}</th>
                        <th class="facebook__table-th">{{ t('days_from_reg') }}</th>
